...
attributes_of_projects = {'Имя проекта': ["Введите новое имя проекта", "project_name"], "Описание": ["Введите новое описание проекта", "description"],
                          "Ссылка": ["Введите новую ссылку на проект", "url"], "Статус": ["Выберите новый статус задачи", "status_id"]}
...
def info_project(message, user_id, project_name):
    ...
    bot.send_message(message.chat.id, f"""Названия проекта: {info[0]}
Описание: {info[1]}
Ссылка: {info[2]}
Статус: {info[3]}
Навыки: {skills}
...
/skill - указать навыки для проекта.

/projects - посмотреть свои проекты.

/delete - по какой то причине удалить свой проект :(

/update_project - обновить данные проекта.
...
# Принимает имя проекта при создании нового
...
# Принимает ссылку на проект при создании нового
...
# Выполняет проверку статуса и сохраняет проект в БД
...
# Выбор навыка для добавления к проекту
def skill_project(message, projects):
    ...
    if project_name not in projects:
        bot.send_message(message.chat.id, 'У тебя нет такого проекта, попробуй еще раз! Выбери проект для которого нужно указать навык',
...
# Проверка навыка и запись изменений
...
# Вывод информации о проекте при получении его названия
